<template>
  <Page>
    ...
    <template v-slot:player-form>
      ...
      <form class="player-add-form" @submit.prevent="addPlayer">
        <input
          v-model="playerName"
          class="player-add"
          type="text"
      ...
      <div
        v-if="isActivePlayer && roomState.draftStarted"
      ...
      <div
        ...
        :class="{
          'character-grid--disabled':
            !roomState.draftStarted || !isActivePlayer,
        }"
      >
        <Character
          ...
          @click.native="
            isActivePlayer &&
              roomState.draftStarted &&
              addCharToPlayer(char.name)
          "
        />
      </div>
    </template>
